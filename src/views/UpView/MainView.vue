<template>
  <div>
    ...
    <el-header class="header" border="1px">
      ...
      <span><el-select v-model="selectedSort" placeholder="排序方式" @change="onChange">
      ...
      <el-option label="最早发布" value="createtimedesc" ></el-option>
    </el-select></span>
      ...
      <el-aside>
        <el-menu class="menu" :collapse="isCollapse">
          ...
          <el-menu-item
            ...
            @click="(this.keyword = ''),(this.selecttype=type.typename), fetchVideoData('', type.typename, this.sort)">
      ...
      <el-main>
          ...
          <div class="carousel-wrapper carousel-container">
            <el-carousel height="500px" arrow="always">
              <el-carousel-item
                ...
                :key="item.id"
              >
                <img :src="item.coverimage" alt="轮播图" />
              </el-carousel-item>
            </el-carousel>
        ...
        <div class="video-grid">
          ...
          >
            ...
            <div class="video-info">
              <div class="video-title">{{ item.title }}</div>
              <div class="video-description">点赞人数：{{ item.goods }}人</div>
              <div class="video-meta">
                共计{{ item.watchcount }} 次观看 ||更新时间
                {{ item.updatetime }}
              </div>
  ...
  >
    ...
    <el-pagination layout="prev,page-size pager, next"
